...
for j in range(4):
    ...
    plt.xlabel("attr_grp_nm")
    plt.ylabel("Conversion Rate")
    plt.savefig("figs/conv_rate_first_"+str((j+1)*10)+"_recommends_by_attr_grp_nm.png", bbox_inches='tight')
    plt.clf()
...
plt.savefig("figs/count_of_processed_cust_by_attr_grp_nm.png", bbox_inches='tight')
plt.clf()
